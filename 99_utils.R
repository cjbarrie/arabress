...
get_similarity_scores <- function(x, 
  ...
  group_first_val <- rowMeans(group_first_val) #TODO this step is unnecessary if first_vec is of length 1
  ...
  group_sec_val <- rowMeans(group_sec_val) #TODO this step is unnecessary if first_vec is of length 1
